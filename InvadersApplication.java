import javax.swing.*;//all imports needed
import java.awt.*;
...
public class InvadersApplication extends JFrame implements Runnable, KeyListener {
    //the enum is used to differenciate the game state and only run certain code when its in a certain state
    ...
    private GameState currentState;//variable to change game states

    private int currentAlienWave = 1;//keeps track of the waves
    private double alienSpeedIncrease = 1.2; // the multiplier of how fast the alien wave get
    private boolean playerAlive = true;//sets the player alive to true
    private final int NUM_ALIENS = 24;//num of aliens
    private Spaceship playerShip;
    private Thread gameThread;
    private BufferStrategy strategy;
    private Alien[] aliens;//the array of aliens
    private boolean movingRight = true;//keeps track of aliens direction
    private final int DOWN_STEP = 20;//how much they step down after reaching border
    private final int ALIEN_WIDTH = 60;
    private Image bulletImage;
    private ArrayList<PlayerBullet> bulletlist = new ArrayList<>();
    private Image menu_Image;//menu image
    private Image gameOver_Image;//end screen image
    public int player_Score;

    public InvadersApplication() {
        // Setup the game window
        this.setTitle("Space Invaders");
        this.setSize(1200, 900);//window size
    ...
    //main game runnig function that updates and renders with error catching
    @Override
    public void run() {
        while (true) {
            try {
